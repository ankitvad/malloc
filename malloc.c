...
//union 'cause you know struct size vs long, whichever bigger dude.!!'
union header {
  struct {
    union header *next;
    unsigned len; //Helps increasing lenght count to double the norma by removing the negatives.
  } meta;
